 ...
 *
 * Runs at 1440 × 900: its pixel expectations derive from that size. See lib.mjs
 * for the flags (`--preview`, `BASE`) and all.mjs for the whole set.
 *
...
export const OPTIONS = { label: 'cockpit', viewport: { width: 1440, height: 900 } };

export async function run({ page, browser, ok, sleep, errors, BASE, PROJECT }) {
